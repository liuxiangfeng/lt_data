...
# Install Hadoop
#
echo "curl -sLko /tmp/hadoop-3.0.0.tar.gz http://apache.osuosl.org/hadoop/common/hadoop-3.0.0/hadoop-3.0.0.tar.gz"
curl -sLko /tmp/hadoop-3.0.0.tar.gz http://apache.osuosl.org/hadoop/common/hadoop-3.0.0/hadoop-3.0.0.tar.gz
...
# Install Spark
#
echo "curl -sLko /tmp/spark-2.2.1-bin-without-hadoop.tgz http://apache.claz.org/spark/spark-2.2.1/spark-2.2.1-bin-without-hadoop.tgz"
curl -sLko /tmp/spark-2.2.1-bin-without-hadoop.tgz http://apache.claz.org/spark/spark-2.2.1/spark-2.2.1-bin-without-hadoop.tgz
...
echo "curl -sLko /home/vagrant/Agile_Data_Code_2/lib/mongo-java-driver-3.6.1.jar http://central.maven.org/maven2/org/mongodb/mongo-java-driver/3.6.1/mongo-java-driver-3.6.1.jar"
curl -sLko /home/vagrant/Agile_Data_Code_2/lib/mongo-java-driver-3.6.1.jar http://central.maven.org/maven2/org/mongodb/mongo-java-driver/3.6.1/mongo-java-driver-3.6.1.jar
...
cp /home/vagrant/elasticsearch-hadoop/dist/elasticsearch-spark-20_2.10-6.1.2.jar /home/vagrant/Agile_Data_Code_2/lib/
echo "spark.speculation false" | sudo tee -a /home/vagrant/spark/conf/spark-defaults.conf
rm -f /tmp/elasticsearch-hadoop-i6.1.2.zip
...
#
echo "curl -sLko /tmp/kafka_2.11-1.0.0.tgz http://www-us.apache.org/dist/kafka/1.0.0/kafka_2.11-1.0.0.tgz"
