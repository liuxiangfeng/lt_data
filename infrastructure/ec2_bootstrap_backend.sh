...
cat > /home/ubuntu/lt_data.message << END_HELLO

Hello, this is LegalTara Backend Servce.

END_HELLO

cat <<EOF | sudo tee /etc/update-motd.d/99-lt-data
#!/bin/bash

cat /home/ubuntu/lt_data.message
EOF
sudo chmod 0755 /etc/update-motd.d/99-lt-data
sudo update-motd
...
git clone https://github.com/global-legaltech/legaltara_backend.git

cd /home/ubuntu/legaltara_backend
...
# under port 80, add proxy_pass to location
 location / {
...
echo "Cloning xxx repository and installing dependencies ..." | tee -a $LOG_FILE
cd /home/ubuntu
git clone git@github.com:liuxiangfeng/lt_data.git
cd /home/ubuntu/lt_Data
export PROJECT_HOME=/home/ubuntu/lt_data
echo "export PROJECT_HOME=/home/ubuntu/lt_data" | sudo tee -a /home/ubuntu/.bash_profile
...
curl -Lko /home/ubuntu/lt_Data/lib/commons-httpclient-3.1.jar http://central.maven.org/maven2/commons-httpclient/commons-httpclient/3.1/commons-httpclient-3.1.jar
...
#
echo "curl -sLko /tmp/elasticsearch-6.2.4.tar.gz https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.2.4.tar.gz"
curl -sLko /tmp/elasticsearch-6.2.4.tar.gz https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-6.2.4.tar.gz
mkdir /home/ubuntu/elasticsearch
cd /home/ubuntu
tar -xvzf /tmp/elasticsearch-6.2.4.tar.gz -C elasticsearch --strip-components=1
...
curl 'localhost:9200/lt_data/on_time_performance/_search?q=Origin:ATL&pretty'
